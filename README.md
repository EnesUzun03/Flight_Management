...
You can then execute your native executable with: `./target/quarkus_crud-1.0.0-SNAPSHOT-runner`
...
- Camel PostgresSQL Replication Slot ([guide](https://camel.apache.org/camel-quarkus/latest/reference/extensions/pg-replication-slot.html)): Poll for PostgreSQL Write-Ahead Log (WAL) records using Streaming Replication Slots
